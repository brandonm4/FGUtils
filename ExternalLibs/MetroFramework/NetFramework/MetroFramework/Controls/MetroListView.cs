...
namespace MetroFramework.Controls
{
    public partial class MetroListView : ListView, IMetroControl
    {
        ...
        private Font stdFont = new Font("Franklin Gothic Book", 11f, FontStyle.Regular, GraphicsUnit.Pixel);
        float _offset = 0.2F;
        ...
        {
            this.Font = new Font("Franklin Gothic Book", 12.0f);
        ...
        void MetroListView_DrawItem(object sender, DrawListViewItemEventArgs e)
        {
            ...
            else if (this.View == View.Tile)
            {
                ...
                foreach (ListViewItem.ListViewSubItem item in e.Item.SubItems)
                {
                    ...
                    TextFormatFlags align = TextFormatFlags.Left;
                    TextRenderer.DrawText(e.Graphics, item.Text, new Font("Franklin Gothic Book", 9.0f), rect, itemForeColor, align | TextFormatFlags.SingleLine | TextFormatFlags.GlyphOverhangPadding | TextFormatFlags.WordEllipsis);
                    _fill += 15;
                }
            }
            else
